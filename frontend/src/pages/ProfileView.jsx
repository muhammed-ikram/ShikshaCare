        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-5xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <Link to="/home" className="text-primary hover:underline">Back to Dashboard</Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">{profile.personalInfo.school}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-500">Class</span>
                                <span className="font-medium">{profile.personalInfo.classStandard}</span>
                            </div>
                            <div className="flex justify-between">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 md:col-span-3">
                        <div className="flex items-center gap-3 mb-4 text-orange-600">
                            ...
                            <h2 className="text-xl font-bold text-gray-800">Academic Snapshot</h2>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="font-semibold text-gray-700 mb-2">Strengths</h3>
                                <div className="flex flex-wrap gap-2">
                                    {profile.academicBaseline.favoriteSubjects?.map(sub => (
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {profile.academicBaseline.difficultSubjects?.map(sub => (
                                        <span key={sub} className="px-3 py-1 bg-red-50 text-red-700 rounded-full text-sm font-medium border border-red-100">{sub}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
